/datum/game_mode
	...
	var/shuttle_auto_call_time = 0 // 120 minutes.  Shuttle auto-called at this time and then again at this time + 1/2 this time, then every 1/2 this time after that. Set to 0 to disable.
